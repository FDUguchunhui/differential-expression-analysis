...
dat <- dat[, c('GENE ID', 'HD1_8hr_CFminus', 'HD1_8hr_CFplus', 'HD2_8hr_CFminus', 
               'HD3_8hr_CFminus', 'HD3_8hr_CFplus')]
...
res_subgroup(res_8hrp_8hrm,reg_dir = 'up', alpha = 0.1, reg_LFC = 2)
